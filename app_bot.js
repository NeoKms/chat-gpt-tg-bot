...
const BotAPIWrapper = require("./BotAPIWrapper");
const chatBot = new BotAPIWrapper(config.BOT_TOKEN);
const fs = require("fs/promises");
const {formatDateJS} = require("./src/helpers/dates");

const addLog = (text) => {
    fs.appendFile("logs.txt",`[${formatDateJS((new Date()/1000)+3600*3,"DD.MM.YYYY hh:mm:ss")}]\n${text}\n`);
}
const chatIdSystems = {};
